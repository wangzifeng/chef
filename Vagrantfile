...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "majortom-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/nodeq"
  #   chef.validation_client_name = "nodeq-validator"
  #   chef.validation_key_path = ".chef/nodeq-validator.pem"
  # end
end
